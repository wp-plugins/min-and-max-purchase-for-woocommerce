...
function vtmam_initialize_options() {
	...
	if  ( false == get_option( 'vtmam_setup_options' ) ) {
		add_option( 'vtmam_setup_options', $this->vtmam_get_default_options() );  //add the option into the table based on the default values in the function.
	} // end if
...
*/
  ...
  //****************************
  	...
  	add_settings_section(
		...
		__( 'System and Debug Options', 'vtmam' ),		// Title to be displayed on the administration page
